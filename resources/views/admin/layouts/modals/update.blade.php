...
<!-- Modal Update User -->
    <div class="modal fade" id="UpdateUserAccountModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xs">
                <div class="modal-content">


                    <form class="update-form" method="POST" id="updateUserAccountForm" action="user/Update" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                     <!-- INPUT GROUPS -->
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="row" id="changepassword_container">
                                                <div class="col-md-6">
