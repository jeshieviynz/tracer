...
<!-- Modal Update User -->
    <div class="modal fade" id="AddAlumniAccountModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xs">
                <div class="modal-content">


                    <form class="update-form" method="POST" id="addAlumniForm" action="/alumni/add" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <div class="col-md-6">
                            <div class="pull-center">ADD ALUMNI</div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="container-fluid">
                                     ...
                                     <!-- INPUT GROUPS -->
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                                 <input class="form-control" value="" placeholder="ID Number" name="username" type="text" required="">
                                            </div>
                            ...
                            <button type="submit" class="btn btn-primary btn-md">&nbsp; &nbsp; &nbsp;ADD ALUMNI&nbsp;  &nbsp;</button>
                        </div>
                        </div>
