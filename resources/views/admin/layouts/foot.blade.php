...
<!--Summwenote-->
<script src="{{ asset('vendor/summer-note/summernote.js') }}"></script>
...
<script src="{{ asset('vendor/datatables/js/dataTables.material.min.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('vendor/bootstrap-multiselect/bootstrap-multiselect.js') }}"></script>
